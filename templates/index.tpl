...
<div class="wrapper">
	...
	<section class="contenu">
	    <h1>
	    	{{_ville.name|capitalize}}, {{_ville.country|upper}}  <!-- ici le tableau ville contient plusieur donnée utilisable -->
	    	<a href="http://maps.google.com/maps?q={{_ville.coord.lat}},{{_ville.coord.lon}}" class="lk" target="_blank" title="Voir sur une carte">
	    		Voir sur une carte
	    	</a>
	    </h1>
	    {% for journee in _journees_meteo %} <!-- bien fermé comme dans la doc de twig-->
	    	<div class="jour">
